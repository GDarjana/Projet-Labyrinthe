...
def Labyrinthe(nomsJoueurs=["joueur1","joueurs2"],nbTresors=24, nbTresorsMax=0):
  labyrinthe = {'Plateau' : Plateau(len(nomsJoueurs), nbTresors), 'Liste de joueurs' : ListeJoueurs(nomsJoueurs)}
  distribuerTresors(labyrinthe['Liste de joueurs'],nbTresors, nbTresorsMax)
  initAleatoireJoueurCourant(labyrinthe['Liste de joueurs'])
  return labyrinthe
  """
...
def getNbParticipants(labyrinthe):
  return getNbJoueurs(labyrinthe['Liste de joueurs'])
  """
...
if __name__ == '__main__':
  labyrinthe = Labyrinthe(nomsJoueurs=["Jiu","Yoohyeon","Siyeon","Sua"],nbTresors=24, nbTresorsMax=0)
